...
const ProfileCard = () => {
  // the appwrite give models where we can get the user
  // User take one type argument here i.e. Preferences means we will get the all the data
  /* Models.User<Models.Preferences> | null is a type that represents either an object conforming to the User interface with nested Preferences, or null if no user is logged in. */
  // The presence of Models.User and Models.Preferences suggests that your application is dealing with data models from Appwrite.
  ...
  useEffect(() => {
    ...
    (async () => {
        // appwrite give me data object where we are storing the user data
          ...
          <div className="flex w-full gap-x-4 items-center">
            ...
            <div className="relative">
              ...
              <div className="text-[12px] p-0.5 inline-block rounded-md bg-gradient-to-tr from-primary to-secondary">
                <button className="px-2 rounded-md font-bold bg-white text-primary">
                  FREE
                </button>
              </div>
            </div>
