...
const Signup = () => {
  ...
  // e:FormEvent<HTMLFormElement>: this is typescript method that tell method will triggered event aur wo Form Event hoga, which give me all HTML Form element
  // instead of this we can use onClick, onSubmit etc.
