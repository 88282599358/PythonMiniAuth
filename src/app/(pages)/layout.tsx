...
const ProtectedLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  useEffect(() => {
    appwriteService
      .isLoggedIn()
      .then(setAuthStatus) // if user is logged in then set the Auth Status
      .finally(() => setLoader(false)); // other wise run finally, because we need the user to be logged in
  }, []);
